      ...
      appBar: AppBar(
        ...
        body: SafeArea(child: ListView(
          children: [
           ...
           Padding(
             padding: const EdgeInsets.only(left:500.0,top:),
             child: Row(
               children: [
                 OutlinedButton.icon(onPressed: (){},icon: const Icon(Icons.save), label:Text('Save')),
                 SizedBox(width: 20,),
                 OutlinedButton.icon(onPressed: (){},icon: const Icon(Icons.report), label:Text('Report')),
                 OutlinedButton.icon(onPressed: (){},icon: const Icon(Icons.cancel), label:Text('Cancel')),
               ],
             ),
           ) 
          ],
