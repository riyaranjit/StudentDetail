                ...
                child: Column(
                  ...
                  Text('Image'),
                    ...
                    child: Column(children: [
                      ...
                      Row(children: [
                        OutlinedButton.icon(onPressed: (){},icon: const Icon(Icons.upload),label:Text('Report'),style:OutlinedButton.styleFrom(
                   backgroundColor: Colors.blue,
                   primary: Colors.white,
                 )),
                 SizedBox(width: 20,),
                 OutlinedButton.icon(onPressed: (){},icon: const Icon(Icons.delete), label:Text('Cancel'),style:OutlinedButton.styleFrom(
