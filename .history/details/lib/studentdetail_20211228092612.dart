          ...
          children: [
           ...
           Center(
             child: Padding(
               ...
               child: Row(
                 children: [
                   Center(child: OutlinedButton.icon(onPressed: (){},icon: const Icon(Icons.save), label:Text('Save'))),
                   Center(child: OutlinedButton.icon(onPressed: (){},icon: const Icon(Icons.report), label:Text('Report'))),
                   Center(child: OutlinedButton.icon(onPressed: (){},icon: const Icon(Icons.cancel), label:Text('Cancel'))),
                 ],
               ),
             ),
           ) 
